...
urlpatterns = [
    ...
    path("content/news/delete/<int:news_id>/", views.delete_news, name="admin_delete_news"),
    path("content/history/delete/<int:history_id>/", views.delete_history, name="admin_delete_history"),
