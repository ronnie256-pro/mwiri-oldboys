"""
Django settings for moba project.
...
ALLOWED_HOSTS = ["147.93.52.129", "srv1361310.hstgr.cloud", "localhost"]
...
STATIC_URL = 'static/'
STATIC_ROOT = 'opt/mwiri-oldboys/staticfiles'

MEDIA_URL = '/media/'
MEDIA_ROOT = '/opt/mwiri-oldboys/media'
